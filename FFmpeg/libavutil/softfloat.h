...
static inline av_const SoftFloat av_add_sf(SoftFloat a, SoftFloat b){
	...
	{
		softFloat.exp = b.exp;
		softFloat.mant = b.mant + (a.mant >> (-t));
	}
	else
	{
		softFloat.exp = a.exp;
		softFloat.mant = a.mant + (b.mant >> t);
	}
...
#ifdef _MSC_VER
	SoftFloat sFloat = {b.exp, -b.mant};

	return av_add_sf(a, sFloat);
#else
...
#ifdef _MSC_VER
	SoftFloat sFloat = {ONE_BITS-frac_bits, v};

    return av_normalize_sf(sFloat);
#else
