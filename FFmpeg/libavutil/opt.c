...
static int av_set_number2(void *obj, const char *name, double num, int den, int64_t intnum, const AVOption **o_out)
{
    ...
    void *dst;
#ifdef _MSC_VER
	AVRational rational = {num*intnum, den};
#endif
    ...
    case FF_OPT_TYPE_INT64: *(int64_t   *)dst= ((int64_t)(num/den))*intnum; break;
#else
...
#ifdef _MSC_VER
		if ((int)num == num) *(AVRational*)dst= rational;
#else
...
AVRational av_get_q(void *obj, const char *name, const AVOption **o_out)
{
    ...
    int den=1;
#ifdef _MSC_VER
	AVRational rational = {intnum, den};
#endif
...
#ifdef _MSC_VER
				{
				int64_t temp = (int64_t)(opt->default_val);
                av_set_int(s, opt->name, temp/*(int64_t)opt->default_val*/);
				}
#else
