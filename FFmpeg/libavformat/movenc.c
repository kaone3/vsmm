...
static int mov_write_chpl_tag(ByteIOContext *pb, AVFormatContext *s)
{
...
#ifdef _MSC_VER
	AVRational rational = {1, 10000000};
#endif
    ...
    for (i = 0; i < nb_chapters; i++) {
        ...
        AVMetadataTag *t;
#ifdef _MSC_VER
        put_be64(pb, av_rescale_q(c->start, c->time_base, rational));
#else
...
#ifdef _MSC_VER
	AVRational rational = {1,MOV_TIMESCALE};
    AVPacket pkt = { 0, 0, NULL, 0, tracknum, AV_PKT_FLAG_KEY };
#else
...
#ifdef _MSC_VER
        int64_t end = av_rescale_q(c->end, c->time_base, rational);
        pkt.pts = pkt.dts = av_rescale_q(c->start, c->time_base, rational);
#else
...
#if CONFIG_MOV_MUXER
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag[] = {
	codec_movvideo_tags,
	codec_movaudio_tags,
	0,
};
...
#if CONFIG_TGP_MUXER
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag_tgp_muxer[] = {
	codec_3gp_tags,
	0,
};
...
#if CONFIG_MP4_MUXER
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag_mp4_muxer[] = {
	ff_mp4_obj_type,
	0,
};
...
#if CONFIG_PSP_MUXER
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag_psp_muxer[] = {
	ff_mp4_obj_type,
	0,
};
...
#if CONFIG_TG2_MUXER
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag_tg2_muxer[] = {
	codec_3gp_tags,
	0,
};
...
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag_ipod_muxer[] = {
	codec_ipod_tags,
	0,
};
