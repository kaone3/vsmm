...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --extra-cflags=-U__STRICT_ANSI__
prefix=/usr/local
...
SRC_PATH="/f/Project/OpenSource/FFmpeg/svn/latest"
SRC_PATH_BARE=/f/Project/OpenSource/FFmpeg/svn/latest
BUILD_ROOT="/f/Project/OpenSource/FFmpeg/svn/latest"
...
TARGET_EXEC=
TARGET_PATH=$(CURDIR)
SDL_LIBS=-L/usr/lib -lmingw32 -lSDLmain -lSDL -mwindows
SDL_CFLAGS=-I/usr/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lavicap32 -lws2_32 -lm -lpthread -lpsapi 
INSTALL=install
LIBTARGET=i386
