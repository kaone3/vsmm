...
#ifdef _MSC_VER
#define AVSample_Fmts(sample_fmt_,name)	\
	static const enum AVSampleFormat sample_fmts_ ## name[] = {sample_fmt_,AV_SAMPLE_FMT_NONE};
#endif
...
#define PCM_CODEC(id, sample_fmt_, name, long_name_)         \
    AVSample_Fmts(sample_fmt_,name) PCM_ENCODER(id,sample_fmt_,name,long_name_) PCM_DECODER(id,sample_fmt_,name,long_name_)
#define PCM_DECODER_FMTS(id, sample_fmt_, name, long_name_)         \
    AVSample_Fmts(sample_fmt_,name) PCM_DECODER(id,sample_fmt_,name,long_name_)
#else
#define PCM_CODEC(id, sample_fmt_, name, long_name_)         \
...
#ifdef _MSC_VER
PCM_DECODER_FMTS(CODEC_ID_PCM_LXF,   AV_SAMPLE_FMT_S32, pcm_lxf, "PCM signed 20-bit little-endian planar");
PCM_DECODER_FMTS(CODEC_ID_PCM_S16LE_PLANAR, AV_SAMPLE_FMT_S16, pcm_s16le_planar, "PCM 16-bit little-endian planar");
#else
