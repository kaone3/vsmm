...
static const enum PixelFormat pix_fmts_pgmyuv_decoder[] = {
	PIX_FMT_YUV420P,
	PIX_FMT_NONE
};
...
static const enum PixelFormat pix_fmts_ppm_decoder[] = {
	PIX_FMT_RGB24,
	PIX_FMT_RGB48BE,
	PIX_FMT_NONE
};
...
static const enum PixelFormat pix_fmts_pbm_decoder[] = {
	PIX_FMT_MONOWHITE,
	PIX_FMT_NONE
};
AVCodec pbm_decoder = {
...
static const enum PixelFormat pix_fmts_pam_decoder[] = {
	PIX_FMT_RGB24,
	PIX_FMT_RGB32,
	PIX_FMT_GRAY8,
	PIX_FMT_MONOWHITE,
