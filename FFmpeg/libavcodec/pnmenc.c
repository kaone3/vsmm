...
static const enum PixelFormat pix_fmts_pgmyuv_encoder[] = {
	PIX_FMT_YUV420P,
	PIX_FMT_NONE
};
AVCodec pgmyuv_encoder = {
	...
	NULL,
	NULL,
	pix_fmts_pgmyuv_encoder,
    NULL_IF_CONFIG_SMALL("PGMYUV (Portable GrayMap YUV) image"),
};
# endif

# if CONFIG_PPM_ENCODER
static const enum PixelFormat pix_fmts_ppm_encoder[] = {
	PIX_FMT_RGB24,
	PIX_FMT_RGB48BE,
	PIX_FMT_NONE
};
AVCodec ppm_encoder = {
	...
	NULL,
	NULL,
	pix_fmts_ppm_encoder,
    NULL_IF_CONFIG_SMALL("PPM (Portable PixelMap) image"),
};
# endif

# if CONFIG_PBM_ENCODER
static const enum PixelFormat pix_fmts_pbm_encoder[] = {
	PIX_FMT_MONOWHITE,
	PIX_FMT_NONE
};
AVCodec pbm_encoder = {
