...
{
#ifdef _MSC_VER
	const uint8_t mediaSubType_Base[] = {MEDIASUBTYPE_BASE_GUID};
#endif
    ByteIOContext *pb = s->pb;
...
#ifdef _MSC_VER
        if (!memcmp(subtype + 4, mediaSubType_Base, 12)) {
#else
...
{
#ifdef _MSC_VER
	uint8_t asf_guid_count = 0;
	const uint8_t asf_guid[][16] = {
...
#ifdef _MSC_VER
            !ff_guidcmp(g, /* DSATTRIB_CAPTURE_STREAMTIME */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* DSATTRIB_PicSampleSeq */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* DSATTRIB_TRANSPORT_PROPERTIES */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* dvr_ms_vid_frame_rep_data */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_AudioTypeSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_ChannelChangeSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_ChannelInfoSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_ChannelTypeSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_PIDListSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_SignalAndServiceStatusSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, /* EVENTID_StreamTypeSpanningEvent */ asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, asf_guid[asf_guid_count++]) ||
            !ff_guidcmp(g, asf_guid[asf_guid_count++]) ||
