...
{
#ifdef _MSC_VER
	ebml_master ebml_master_ret;
#endif
    int bytes = expectedsize ? ebml_num_size(expectedsize) : 8;
    put_ebml_id(pb, elementid);
    put_ebml_size_unknown(pb, bytes);
#ifdef _MSC_VER
	ebml_master_ret.pos = url_ftell(pb);
	ebml_master_ret.sizebytes = bytes;
    return ebml_master_ret;
#else
...
# ifdef _MSC_VER
static const AVCodecTag* const codec_tag_matroska_audio_muxer[] = {
	ff_codec_wav_tags,
	0,
};
AVOutputFormat matroska_audio_muxer = {
	...
	NULL,
	NULL,
	codec_tag_matroska_audio_muxer,
};
# else	/* _MSC_VER */
AVOutputFormat matroska_audio_muxer = {
    "matroska",
