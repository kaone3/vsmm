...
#if (CONFIG_FLASHSV_ENCODER || CONFIG_FLASHSV_DECODER)
...
#if (CONFIG_PNG_ENCODER || CONFIG_PNG_DECODER)
...
#if (CONFIG_ZLIB_DECODER || CONFIG_ZLIB_ENCODER)
    REGISTER_ENCDEC  (ZLIB, zlib);
#endif
#if (CONFIG_ZMBV_DECODER || CONFIG_ZMBV_ENCODER)
...
#endif
#if (CONFIG_LIBGSM_MS_DECODER || CONFIG_LIBGSM_MS_ENCODER)
