...
#ifdef _MSC_VER
static const OptionDef options[122];
#else
...
#ifdef _MSC_VER
    FFSinkContext ffsink_ctx = { codec->pix_fmt };
#else
...
{
#ifdef _MSC_VER
	const enum PixelFormat MJPEG_Fmts[] = {PIX_FMT_YUVJ420P, PIX_FMT_YUVJ422P, PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_NONE};
	const enum PixelFormat LJPEG_Fmts[] = {PIX_FMT_YUVJ420P, PIX_FMT_YUVJ422P, PIX_FMT_YUVJ444P, PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_YUV444P, PIX_FMT_BGRA, PIX_FMT_NONE};
#endif
...
#ifdef _MSC_VER
        sub->pts              += av_rescale_q(sub->start_display_time, rational, AV_TIME_BASE_Q);
#else
...
#ifdef _MSC_VER
            av_compare_ts(pkt.pts, ist->st->time_base, recording_time + start_time, rational) >= 0) {
#else
...
static void new_video_stream(AVFormatContext *oc, int file_idx)
{
    ...
    if (video_stream_copy) {
        ...
        int i;
#ifdef _MSC_VER
        AVRational rational = {25,1};
        AVRational fps= frame_rate.num ? frame_rate : rational;
#else
