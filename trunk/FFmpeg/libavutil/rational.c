...
#ifdef _MSC_VER
			{
				rational.num = x*a1.num + a0.num;
				rational.den = x*a1.den + a0.den;
				a1 = rational;
			}
#else
...
#ifdef _MSC_VER
	AVRational rational = {c.den, c.num};

	return av_mul_q(b, rational);
#else
...
#ifdef _MSC_VER
	AVRational rational = {-c.num, c.den};

	return av_add_q(b, rational);
#else
